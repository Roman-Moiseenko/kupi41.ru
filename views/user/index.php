...
<form class="col-md-8" method="post" action="#" id="edit_form">
    <div class="row">
        <div class="col">
    ...
    <div class="form-group form-check">
        <input type="checkbox" class="form-check-input form-control-sm" id="firmcheck" data-toggle="collapse"
            ...
            <?=isset($firm) ? 'checked' : '';?> <?=isset($firm) ? 'disabled' : '';?>>
    ...
    <button type="submit" class="btn btn-default" id="edit_submit" name="submit">Сохранить</button>
</form>