...
class Pagination
{
     ...
     * @return
     */
    public function __construct($total, $currentPage, $limit, $index, $classAjax = '')
    {
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        //$idcategoty = 0; //$currentURI

        return
            //'<li><a href="/site/catalog//'. $this->index . $page.'" class="'.$this->classAjax.'" page="'.$page.'" category="0">' . $text . ' </a></li>';
