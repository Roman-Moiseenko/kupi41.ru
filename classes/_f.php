...
class _f
{
    ...
    static public function shortname($str, $length = _f::MAX_LENGHT)
    {
...
//        die($str);
    ...
    static public function dateToHTML($date)
    {
        $month = array('января', 'февраля', 'марта', 'апреля', 'мая', 'июня', 'июля', 'августа', 'сентября', 'октября', 'ноября', 'декабря');
        $result = date('d', $date) . ' ' . $month[date('n', $date) - 1] . ' ' . date('Y', $date) . ' г.';
        return $result;
    ...
    static public function num2str($num) {
        ...
        //
        //die(sprintf("%015.2f", floatval($num)));
